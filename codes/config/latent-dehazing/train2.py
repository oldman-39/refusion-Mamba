...
def main():
    ...
    if opt['path']['daclip'] is not None:
        clip_model, preprocess = open_clip.create_model_from_pretrained('daclip_ViT-B-32',
    ...
    for epoch in range(start_epoch, total_epochs + 1):
        ...
        for _, train_data in enumerate(train_loader):
            ...
            model.feed_data(states, latent_LQ, latent_GT, text_context=degra_context, image_context=image_context) # xt, mu, x0
            ...
            if current_step % opt["train"]["val_freq"] == 0 and rank <= 0:
                ...
                for _, val_data in enumerate(val_loader):
                    ...
                    # valid Predictor
                    model.feed_data(noisy_state, latent_LQ, GT, text_context=degra_context, image_context=image_context)
