...
# parser.add_argument("-opt", type=str, default='./options/dehazing/test/refusion.yml', help="Path to options YMAL file.")
...
os.system("rm ./result")
os.symlink(os.path.join(opt["path"]["results_root"], ".."), "./results")
...
# 计算模型存储大小
param_size_in_bytes = total_params * 4  # 每个参数4字节
